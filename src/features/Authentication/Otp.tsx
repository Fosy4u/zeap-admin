...
const Otp = ({close,  user}: {
  ...
  return (
    <div id="default-modal" tabIndex={-1} aria-hidden="true" className=" overflow-y-auto  fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    ...
    <div className="w-full max-w-6xl mx-auto px-4 md:px-6 ">
        <div className="flex justify-center">
            ...
            {(verifyOtpStatus.isLoading || sendOtpStatus?.isLoading) && <Loading />}
            ...
            <button
                ...
                <header className="mb-8">
                    ...
                    {pin_id && <><p className="text-[15px]  text-slate-500">Enter the 4-digit verification code that was sent to</p> <strong className="text-[15px] text-slate-500">{`${capitalizeFirstLetter(user?.firstName)}'s  phone number.`}</strong> </>}
                </header>
