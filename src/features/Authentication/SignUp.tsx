...
const SignUp =  ({close, user, mode="create"}:{
  close: () => void,
...
const topRef = useRef<HTMLDivElement>(null);
  ...
  const validateForm = () => {
    let error = "";
    let valid = true;
    if (!email || !password || !confirmPassword || !firstName || !lastName || !phoneNumber || !address || !region || !country) {
...
...(_.isEqual(social, user?.social) ? {} : {social : JSON.stringify(social)}),
    ...
    editUser({payload, userId: user?.userId || ""}).unwrap()
    .then((res) => {
        console.log("res", res)
        setError(null);
        setFirstName(user?.firstName || "");
...
<span className="absolute right-4 top-4"
                 ...
                 className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={(e) => setSocial({...social, website: e.currentTarget.value})}
                 ...
                 className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={(e) => setSocial({...social, twitter: e.currentTarget.value})}
                 ...
                 className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={(e) => setSocial({...social, facebook: e.currentTarget.value})}
                 ...
                 className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={(e) => setSocial({...social, instagram: e.currentTarget.value})}
  ...
  <path fill="currentColor" fill-rule="evenodd" d="M3 8a5 5 0 0 1 5-5h8a5 5 0 0 1 5 5v8a5 5 0 0 1-5 5H8a5 5 0 0 1-5-5V8Zm5-3a3 3 0 0 0-3 3v8a3 3 0 0 0 3 3h8a3 3 0 0 0 3-3V8a3 3 0 0 0-3-3H8Zm7.597 2.214a1 1 0 0 1 1-1h.01a1 1 0 1 1 0 2h-.01a1 1 0 0 1-1-1ZM12 9a3 3 0 1 0 0 6 3 3 0 0 0 0-6Zm-5 3a5 5 0 1 1 10 0 5 5 0 0 1-10 0Z" clip-rule="evenodd"/>
                ...
                <button className=" w-full cursor-pointer rounded-lg border border-primary bg-baseGreen p-4 text-white transition hover:bg-opacity-90 py-2.5 px-5 mr-2 focus:z-10 focus:ring-4 focus:outline-none  text-center"  onClick={
                      (e => {
                        e.preventDefault();
