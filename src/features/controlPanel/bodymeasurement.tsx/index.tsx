...
import BodyMeasurementGuide from './components/BodyMeasurementGuide';
import { useEffect, useState } from 'react';
import { Alert, Modal } from 'flowbite-react';
import NoPic from '../../../images/icon/noPhoto.png';
import BodyMeasurementGuideImageButton from './components/BodyMeasurementGuideImageButton';
import BodyMeasurementGuideImageDeleteButton from './components/BodyMeasurementGuideImageDeleteButton';
import BodyMeasurementEditModal from './components/BodyMeasurementEditModal';
...
const BodyMeasurement = () => {
  ...
  const getBodyMeasurementGuideQuery =
    zeapApiSlice.useGetBodyMeasurementGuideQuery({}, { skip: !token });
