...
const SearchHelpArticle = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full max-w-2xl mx-auto mb-4">
      <div
        className={`flex flex-col items-center justify-center w-full max-w-md p-4 bg-white dark:bg-boxdark rounded-lg  ${input && filteredHelpArtices.length > 0 ? 'shadow-lg' : ''}`}
      >
