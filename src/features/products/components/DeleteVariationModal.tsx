...
const DeleteVariationModal = ({ close,open,  variation, productId}:{
    ...
    const [deleteVariation, diableVariationStatus ] = zeapApiSlice.useDeleteProductVariationMutation();
    ...
    const handleDeleteVariation = () => {
       ...
       sku: variation?.sku
        ...
        deleteVariation({payload}).unwrap()
        .then(() => {
            close(false)
