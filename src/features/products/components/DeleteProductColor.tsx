...
const DeleteProductColor = ({ close,open,  color, productId}:{
    ...
    const [deleteColor, diableColorStatus ] = zeapApiSlice.useDeleteProductColorMutation();
