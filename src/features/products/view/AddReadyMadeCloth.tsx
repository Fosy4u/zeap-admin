...
const AddReadyMadeCloth = () => {
  const { setDimBackground} = useContext(ThemeContext);
   ...
   const [openSubmitModal, setOpenSubmitModal] = useState(false)
    ...
    const styleOptions = options?.readyMadeClothes?.styleEnums?.map((str:string, index:number) => ({ value: str, id: index + 1 })).sort((a:any, b:any) => a.value.localeCompare(b.value));
    ...
    const handleValidation = () => {
        ...
        if(stage === 2){
            ...
            if(categories?.age?.ageGroup === "Kids" && categories?.age?.ageRange === ""){
...
<ol className="flex items-center w-full mb-4 sm:mb-5">
    <li className={`${getClass(1)} md:after:content-['Basic_Details']`}>
        <div className={`flex items-center justify-center w-10 h-10  rounded-full lg:h-12 lg:w-12  shrink-0 ${stage === 1 && "bg-blue-100"}`}>
  ...
  <path fill-rule="evenodd" d="M2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10S2 17.523 2 12Zm9.408-5.5a1 1 0 1 0 0 2h.01a1 1 0 1 0 0-2h-.01ZM10 10a1 1 0 1 0 0 2h1v3h-1a1 1 0 1 0 0 2h4a1 1 0 1 0 0-2h-1v-4a1 1 0 0 0-1-1h-2Z" clip-rule="evenodd"/>
    ...
    <li className={`${getClass(2)} md:after:content-['Categories']`}>
        <div className={`flex items-center justify-center w-10 h-10  rounded-full lg:h-12 lg:w-12  shrink-0 ${stage === 2 && "bg-blue-100"}`}>
        <svg className="w-4 h-4 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
  <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.9" d="M9.143 4H4.857A.857.857 0 0 0 4 4.857v4.286c0 .473.384.857.857.857h4.286A.857.857 0 0 0 10 9.143V4.857A.857.857 0 0 0 9.143 4Zm10 0h-4.286a.857.857 0 0 0-.857.857v4.286c0 .473.384.857.857.857h4.286A.857.857 0 0 0 20 9.143V4.857A.857.857 0 0 0 19.143 4Zm-10 10H4.857a.857.857 0 0 0-.857.857v4.286c0 .473.384.857.857.857h4.286a.857.857 0 0 0 .857-.857v-4.286A.857.857 0 0 0 9.143 14Zm10 0h-4.286a.857.857 0 0 0-.857.857v4.286c0 .473.384.857.857.857h4.286a.857.857 0 0 0 .857-.857v-4.286a.857.857 0 0 0-.857-.857Z"/>
</svg>

        </div>
    </li>
    <li className={`${getClass(3)} md:after:content-['Sizes']`}>
        <div className={`flex items-center justify-center w-10 h-10  rounded-full lg:h-12 lg:w-12  shrink-0 ${stage === 3 && "bg-blue-100"}`}>
        <svg className="w-4 h-4 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
  <path stroke="currentColor" strokeLinecap="round" strokeWidth="1.9" d="M5 7h14M5 12h14M5 17h10"/>
</svg>

        </div>
    </li>
    <li className={`${getClass(4)} md:after:content-['Images_and_Colors']`}>
        <div className={`flex items-center justify-center w-10 h-10  rounded-full lg:h-12 lg:w-12  shrink-0 ${stage === 4 && "bg-blue-100"}`}>
        <svg className="w-4 h-4 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
  <path d="M5 3a2 2 0 0 0-2 2v2a2 2 0 0 0 2 2h4a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2H5Zm14 18a2 2 0 0 0 2-2v-2a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2a2 2 0 0 0 2 2h4ZM5 11a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h4a2 2 0 0 0 2-2v-6a2 2 0 0 0-2-2H5Zm14 2a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h4Z"/>
    ...
    <li className={`${getClass(5)} md:after:content-['Variations']`}>
        <div className={`flex items-center justify-center w-10 h-10  rounded-full lg:h-12 lg:w-12  shrink-0 ${stage === 5 && "bg-blue-100"}`}>
        <svg className="w-4 h-4 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
...
<div >
    <h3 className="md:hidden mb-4 text-lg font-medium leading-none text-darkGold">{getLabel()}</h3>
    <div className="flex flex-col gap-4 min-h-[57vh] overflow-auto">
        {isLoading && <Loading />}
        {serverError && <Alert color="failure"icon={HiInformationCircle} className="my-4">{serverError}</Alert>}
        {stage === 1 && <>
    <div>
        <div className="mb-2 block">
          <Label  value="Title" />
        </div>
        <TextInput  type="text" placeholder="Title / Name of the product" required 
        value={title}
        onChange={(e) => setTitle(e.target.value)}
       color={getColor(title, error.title)}
        helperText={error.title && !title ?  <>
    ...
    <div>
        ...
        <TextInput type="text" placeholder="Subtitle if any..."
        value={subtitle}
    ...
    <div className='border rounded p-2'>
        <div className="mb-2 block">
          ...
          {styleOptions?.length > 0 && <div >
            <Multiselect
            options={styleOptions}
            displayValue="value"
            onSelect={(selectedList) =>{setCategories({...categories, style:selectedList.map((item:any) => item.value)})}}
            onRemove={(selectedList) => setCategories({...categories, style:selectedList.map((item:any) => item.value)})}
            selectedValues={styleOptions.filter((item:any) => categories.style.includes(item.value))}
            ...
            {error.style && categories?.style?.length === 0 && <span className="text-xs text-danger">{error.style}</span>}
        </div>
    </div>
    ...
    <div className='border rounded p-2'>
        <div className="mb-2 block">
          <Label  value="Gender" />
            ...
            {genderOptions?.length > 0 && <div >
            <Multiselect
            options={genderOptions}
            displayValue="value"
            onSelect={(selectedList) =>{setCategories({...categories, gender:selectedList.map((item:any) => item.value)})}}
            onRemove={(selectedList) => setCategories({...categories, gender:selectedList.map((item:any) => item.value)})}
            selectedValues={genderOptions.filter((item:any) => categories.gender.includes(item.value))}
            ...
            {error.gender && categories?.gender?.length === 0 && <span className="text-xs text-danger">{error.gender}</span>}
          </div>
    ...
    <div className='border rounded p-2'>
        <div className="mb-2 block">
          ...
          <div className='flex flex-col-gap-2'>
                ...
                {ageGroupEnums?.map((item:string, index:number) => (
                    <Dropdown.Item  className="text-black" key={index} onClick={() => {
                        if(item === "Adults"){
                            ...
                            setCategories({...categories, age: {ageGroup: item, ageRange: ""}})
                        }
                    }}>{item}</Dropdown.Item>
                ))}
            </Dropdown>
            </div>
            {categories?.age?.ageGroup === "Kids" && <div>
                <div className='text-xs text-slate-500 mb-2'>
            ...
            {error.age && (!categories?.age?.ageGroup || (categories?.age?.ageGroup === "Kids" && !categories?.age?.ageRange)) && <span className="text-xs text-danger">{error.age}</span>}
    ...
    <div className='border rounded p-2'>
        <div className="mb-2 block">
          ...
          <div className='text-xs text-slate-500 mb-2'>
            ...
            {designOptionEnums?.length > 0 && <div >
            <Multiselect
            options = {designOptionEnums}
            displayValue="value"
            onSelect={(selectedList) =>{setCategories({...categories, design:selectedList.map((item:any) => item.value)})}}
            onRemove={(selectedList) => setCategories({...categories, design:selectedList.map((item:any) => item.value)})}
            selectedValues={designOptionEnums.filter((item:any) => categories.design.includes(item.value))}
...
<div className='border rounded p-2'>
        <div className="mb-2 block">
          ...
          <div className='text-xs text-slate-500 mb-2'>
            ...
            {occasionOptionEnums?.length > 0 && <div >
            <Multiselect
            options = {occasionOptionEnums}
            displayValue="value"
            onSelect={(selectedList) =>{setCategories({...categories, occasion:selectedList.map((item:any) => item.value)})}}
            onRemove={(selectedList) => setCategories({...categories, occasion:selectedList.map((item:any) => item.value)})}
            selectedValues={occasionOptionEnums.filter((item:any) => categories.occasion.includes(item.value))}
    ...
    <div className='border rounded p-2'>
        <div className="mb-2 block">
          ...
          <div className='text-xs text-slate-500 mb-2'>
            ...
            {fasteningOptionEnums?.length > 0 && <div >
            <Multiselect
            options = {fasteningOptionEnums}
            displayValue="value"
            onSelect={(selectedList) =>{setCategories({...categories, fastening:selectedList.map((item:any) => item.value)})}}
            onRemove={(selectedList) => setCategories({...categories, fastening:selectedList.map((item:any) => item.value)})}
            selectedValues={fasteningOptionEnums.filter((item:any) => categories.fastening.includes(item.value))}
    ...
    {stage === 3 && <div className='border rounded p-2'>
        <div className="mb-2 block">
          <Label  value="Size" />
        </div>
        <div className='text-xs text-slate-500 mb-2'>
        ...
        {sizeOptionEnums?.length > 0 && <div>
            <Multiselect
            options = {sortNaturally(sizeOptionEnums, "value")}
            displayValue="value"
            onSelect={(selectedList) =>{setSizes(selectedList.map((item:any) => item.value))}}
            onRemove={(selectedList) => setSizes(selectedList.map((item:any) => item.value))}
            selectedValues={sizeOptionEnums.filter((item:any) => sizes.includes(item.value))}
