...
const AddBespokeCloth = () => {
  ...
  return (
    <div>
      <ProductHeader title={`Bespoke Cloth: Shop - ${shopId}`} />
                    ...
                    <div>
                      <Multiselect
                        ...
                        onSelect={(selectedList) => {
                          setCategories({
                            ...categories,
                            main: selectedList.map((item: any) => item.value),
                          });
                        }}
                        ...
                        selectedValues={mainOptions.filter((item: any) =>
                    ...
                    <div>
                      <Multiselect
                        ...
                        onSelect={(selectedList) => {
                          setCategories({
                            ...categories,
                            fit: selectedList.map((item: any) => item.value),
                          });
                        }}
                        onRemove={(selectedList) =>
                          setCategories({
                        ...
                        selectedValues={fitOptionEnums.filter((item: any) =>
...
export default AddBespokeCloth;
