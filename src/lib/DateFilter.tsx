  ...
  const dateFilterOptions = [
    ...
    return (
      <span className="text-sm text-gray-600">
        <Dropdown color="success" size="xs" label={dateFilterOptions?.find(
          ...
          {openCustom && (
            <div className="flex gap-2 items-center">
             <DatePicker
              ...
              setValue={(date: Date) => {setCustomFrom(date); setFrom(date)}}
            ...
            <span className="text-gray-600 text-center">to</span>
              ...
              <DatePicker
                ...
                setValue={(date: Date) => {setCustomTo(date); setTo(date)}}
